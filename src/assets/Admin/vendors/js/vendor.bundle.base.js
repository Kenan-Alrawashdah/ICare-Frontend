...
!(function(t, e) {
    ...
    function ne(t, e, i) {
        ...
        return (
            ...
            (("body" !== at(e) || Ut(o)) &&
                (l =
                    (n = e) !== lt(n) && dt(n) ? { scrollLeft: (s = n).scrollLeft, scrollTop: s.scrollTop } :
                    Wt(n)),
                dt(e) ?
    ...
    var E = {
        ...
        H = function(d, e) {
            ...
            isNaN(this.scrollbarYRight) ?
                ...
                (this.reach = {
                    x: 0 >= d.scrollLeft ?
                        "start" : d.scrollLeft >= this.contentWidth - this.containerWidth ?
                        "end" : null,
                    y: 0 >= d.scrollTop ?
                        "start" : d.scrollTop >= this.contentHeight - this.containerHeight ?
                        "end" : null,
                }),
                (this.isAlive = !0),
